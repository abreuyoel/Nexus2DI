    ...
    <div class="p-6 max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div *ngIf="!loading && !encuestaActiva" class="bg-slate-900 rounded-xl p-8 border border-white/10 shadow-xl max-w-4xl mx-auto">
        ...
        <div class="mt-6 pt-6 border-t border-slate-800">
          <div class="bg-indigo-500/10 border border-indigo-500/30 rounded-xl p-5 flex items-start gap-4 text-indigo-200">
            <span class="material-icons text-indigo-400 !text-2xl mt-0.5">info</span>
            <div class="text-sm">
              <span class="font-bold text-white block mb-1">¿No encuentras el centro de salud que buscas?</span>
              Si necesitas registrar un nuevo centro médico en el sistema, por favor contacta a tu supervisor para que lo agregue y esté disponible inmediatamente en la lista.
            </div>
          </div>
        </div>
      </div>
