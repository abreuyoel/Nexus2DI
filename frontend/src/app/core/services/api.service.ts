...
export class ApiService {
  ...
  getCentroMandoHorasTrabajadas(opts: { desde?: string; hasta?: string } = {}): Observable<any> { return this.http.get<any>(`${this.base}/api/centro-mando/horas-trabajadas`, { params: this.params(opts) }); }
