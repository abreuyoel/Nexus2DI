...
def ensure_servicio_prefijo_column() -> None:
    ...
    con el mismo prefijo que usaba la whitelist E/T/A hardcodeada en el controlador
    de rutas -- sin este backfill, crear una ruta para esos servicios dejaría de
