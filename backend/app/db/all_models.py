...
from app.modules.visits.entities import Visita, Foto, NotificacionRechazoFoto, PushSubscription, FotoRazonRechazo, Activacion, Balance, AuditoriaTiempo  # noqa: F401
from app.modules.chat.entities import (  # noqa: F401
    ChatMensaje, ChatConversacion, ChatParticipante, ChatMensajeLectura,
    ChatGrupo, ChatGrupoMiembroExtra, ChatGrupoMensaje, ChatGrupoLectura,
    ChatGrupoMensajeLectura, ChatMensajeGrupoVisita, ChatGrupoVisitaLectura,
)
...
from app.modules.surveyors.entities import Encuestador, JornadaEncuestador, CentroSalud, EncuestaCentro, Medico, MedicoCentroEncuesta  # noqa: F401
from app.modules.executives.entities import Ejecutivo  # noqa: F401
